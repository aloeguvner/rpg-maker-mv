...
Window_Selectable.prototype.sortPriorityList = function() {
    if(this._data) {
        if(this._data[this._data.length - 1] === null) { //equip item list
            this._data = this._data.filter(function(a){return a});
            this._data.sort(function(a,b){return a.sortPriority - b.sortPriority});
            this._data.push(null);
        } else { //all other item lists
            this._data.sort(function(a,b) {return a.sortPriority - b.sortPriority});
        }
    }
};